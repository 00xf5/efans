    ...
    return (
        <nav className={`${hideOnMessages ? 'hidden md:flex md:fixed md:top-0 md:left-0 md:right-0 md:z-50' : 'fixed top-0 left-0 right-0 z-50'} glass h-16 flex items-center px-4 md:px-6 justify-between overflow-hidden`}>
            ...
            <div className="hidden md:flex items-center gap-8 text-sm font-medium">
                <Link to="/timeline" className="hover:text-primary transition-colors text-zinc-400">The Stream</Link>
                <Link to="/creators" className="hover:text-primary transition-colors text-zinc-400">Discover</Link>
                <Link to="/about" className="hover:text-primary transition-colors text-zinc-400">Features</Link>
                <Link to="/pricing" className="hover:text-primary transition-colors text-zinc-400">Pricing</Link>
            </div>
