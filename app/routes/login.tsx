                ...
                <div className="w-full max-w-lg space-y-12 relative z-10">
                    <header className="space-y-4 text-center lg:text-left">
                        ...
                        <h1 className="text-5xl font-black text-white leading-tight italic">
                            Welcome <br />
                            <span className="text-zinc-600 font-black">Back.</span>
                        </h1>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <div className="flex justify-between items-center pr-6">
                                    <label className="text-[10px] font-black text-zinc-500 uppercase tracking-widest block ml-6 leading-none">Security Key</label>
                                    <Link to="/forgot" className="text-[9px] font-black text-zinc-400 uppercase tracking-widest hover:text-primary transition-colors">Recover?</Link>
                                </div>
                                <input
                                    type="password"
                                    placeholder="••••••••••••"
                    ...
                    <footer className="pt-10 border-t border-zinc-900 flex items-center justify-between">
                        ...
                        <div className="flex gap-4">
                            {['Google', 'Twitter', 'Apple'].map(s => (
                                <button key={s} className="w-10 h-10 rounded-xl border border-zinc-800 flex items-center justify-center hover:bg-zinc-900 transition-all group">
                                    <span className="text-[9px] font-black text-zinc-500 group-hover:text-white transition-colors uppercase">{s[0]}</span>
                                </button>
                            ))}
                        </div>
                    </footer>
